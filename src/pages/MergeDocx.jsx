...
export default function MergeDocx() {
  ...
  const handleMerge = async () => {
    if (files.length < 2) { setError('Please select at least 2 Word files'); return; }
  ...
  return (
    <div className="tool-page">
      <ToolHero
        ...
        subheading="Combine multiple Word files (.docx, .doc) into one. Set order, merge in seconds. Free, secure, no signup."
        uploadProps={{
          accept: '.docx,.doc',
          multiple: true,
          id: 'merge-docx-input',
          ...
          placeholder: 'Choose Word files',
          label: 'Click or drag Word files here',
        }}
      >
        {files.length > 0 && (
